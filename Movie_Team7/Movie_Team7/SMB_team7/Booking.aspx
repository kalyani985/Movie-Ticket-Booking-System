<%@ Page Title="" Language="C#" MasterPageFile="~/SMB_team7/cinema.Master" AutoEventWireup="true" CodeBehind="Booking.aspx.cs" Inherits="Movie_Team7.SMB_team7.Booking" %>
...
&nbsp;<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:CheckBox ID="E1" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;&nbsp;&nbsp;
                <asp:CheckBox ID="E2" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;&nbsp;
                <asp:CheckBox ID="E3" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;
                <asp:CheckBox ID="E4" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;&nbsp;
                <asp:CheckBox ID="E5" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;&nbsp;
                <asp:CheckBox ID="E6" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;&nbsp;&nbsp;
                <asp:CheckBox ID="E7" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;&nbsp;
                <asp:CheckBox ID="E8" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;&nbsp;
                <asp:CheckBox ID="E9" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;
                <asp:CheckBox ID="E10" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;&nbsp;
                <asp:CheckBox ID="E11" runat="server" OnCheckedChanged="D13_CheckedChanged" />
&nbsp;&nbsp;&nbsp;
                <asp:CheckBox ID="E12" runat="server" OnCheckedChanged="D13_CheckedChanged" />
            </td>
        </tr>
    </table>
&nbsp;<table class="movies">
    ...
    <table class="movies">
        <tr>
            <td class="auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:Button ID="bookGuestButton" runat="server" Text="confirm as Guest" Width="122px" />
            </td>
            <td class="auto-style4">&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:Button ID="bookMemberButton" runat="server" Text="confirm as Member" Width="130px" />
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
