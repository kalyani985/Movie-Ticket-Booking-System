<%@ Page Title="" Language="C#" MasterPageFile="~/SMB_team7/cinema.Master" AutoEventWireup="true" CodeBehind="Refund.aspx.cs" Inherits="Movie_Team7.SMB_team7.Refund" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="movies">
        <tr>
            ...
            <td aria-disabled="False" aria-hidden="True">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:Button ID="RefundButton" runat="server" OnClick="RefundButton_Click" Text="Refund" />
            </td>
        </tr>
    </table>
